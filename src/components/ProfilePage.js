...
const Results = () => (
  <Box style={{background:"Aqua",color:"white"}} clone>
    <div>
      ...
      return (
        ...
        <div width="100%" style={{display: 'flex',justifyContent: 'center'}}>
            <Breadcrumbs aria-label="breadcrumb" style={{color:"white",fontSize:"16px"}}>
                <Button  style={{color:"white",fontSize:"11px"}} variant="contained" color="secondary" target="_blank" onClick={onClickExp}><BusinessIcon color="white" style={{marginRight:"3px"}}/>Experience</Button>
                <Button  style={{color:"white",fontSize:"11px"}} variant="contained" color="secondary" target="_blank" onClick ={onClickEdu}><SchoolIcon color="white" style={{marginRight:"3px"}}/>Education</Button>
                <Button  style={{color:"white",fontSize:"11px"}} variant="contained" color="secondary" target="_blank" onClick={onClickTech}><BuildIcon color="white" style={{marginRight:"3px"}}/>Tech Skills</Button>
            </Breadcrumbs>
        </div>
        <div>
