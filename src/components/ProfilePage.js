...
const Results2 = () => (
  ...
  <p>SHOW STUFF PLEASE</p>
      ...
      return (
        <>
        <div>
            <h1 style={{marginTop:"0px",fontSize: "3rem",fontWeight: "bold",fontFamily:"Comic Sans MS",fontStyle: "italic",color:"darkred"}}>Viktor Shcheglov Full Stack Developer</h1>
            <h2 style={{marginTop:"0px",fontSize: "1.5rem",fontFamily:"Raleway",color:"darkred"}}>
        ...
        <div width="100%" style={{display: 'flex',justifyContent: 'center'}}>
            <Breadcrumbs aria-label="breadcrumb" style={{color:"white",fontSize:"16px"}}>
                <Button  style={{color:"white",fontSize:".75rem"}} variant="contained" color="secondary" target="_blank" onClick={onClickExp}><BusinessIcon color="white" style={{marginRight:"3px"}}/>Experience</Button>
                <Button  style={{color:"white",fontSize:".75rem"}} variant="contained" color="secondary" target="_blank" onClick ={onClickEdu}><SchoolIcon color="white" style={{marginRight:"3px"}}/>Education</Button>
                <Button  style={{color:"white",fontSize:".75rem"}} variant="contained" color="secondary" target="_blank" onClick={onClickTech}><BuildIcon color="white" style={{marginRight:"3px"}}/>Tech Skills</Button>
            </Breadcrumbs>
        </div>
        <div>
